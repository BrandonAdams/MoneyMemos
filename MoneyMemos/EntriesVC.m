...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [DataStore sharedStore].currentLocation.entries.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [NSString stringWithFormat: @"%.2f",((Entry *)[DataStore sharedStore].currentLocation.entries[indexPath.row]).amount];
